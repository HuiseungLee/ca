...
- 로그인 전: 공지사항과 교사가 공개한 활동지 전체 문항 조회
- 학생: 통합 계정 가입, 희망 진로 설정, 활동 보고서 제출, 진로 적합도·다음 심화 활동 확인
- 교사: 활동지 제목·안내·문항·필수 여부 편집 및 공개, 학생별 성장 관찰 단서 확인
...
3. 프로젝트를 빌드하고 실행합니다. 기본 NAS 포트는 `7310`이며 새 데이터 구조는 컨테이너 시작 시 기존 기록을 보존한 채 자동 적용됩니다.
